...
require import AllCore Int Distr FSet SmtMap Real Bool DBool.
...
(* PRHL judgement relating 
G1.f and G2.f. ={res} means res{1} = res{2},
i.e., the result of G1.f is equal to (has same distributionas) result of G2.f *)
