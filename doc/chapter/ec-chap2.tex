...
\begin{tikzpicture}[auto, node distance=2cm, >=latex']
	...
	% Nodes
	\node [draw, rectangle, rounded corners, text centered, minimum height=2em, minimum width=8em] (easycrypt) {EasyCrypt};
	\node [draw, rectangle, rounded corners, below of=easycrypt, node distance=2cm, text centered, minimum height=2em, minimum width=8em] (proofgeneral) {Proof General};
	\node [draw, rectangle, rounded corners, below of=proofgeneral, node distance=2cm, text centered, minimum height=2em, minimum width=8em] (coq) {Coq};
	
	% Arrows
	\draw [->] (easycrypt) -- (proofgeneral);
	\draw [->] (proofgeneral) -- (coq);
	
	% Labels
	\node [below of=coq, node distance=1.2cm] (label) {};
	\node [text width=10cm] at (label) {Integration of Proof General within EasyCrypt};
